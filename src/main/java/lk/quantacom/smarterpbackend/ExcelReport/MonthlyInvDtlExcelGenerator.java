...
public class MonthlyInvDtlExcelGenerator {
    ...
    public MonthlyInvDtlExcelGenerator(List<getMonthlyDtlsByAllResponse> responseList) {
    ...
    private void writeHeader() {
        ...
        sheet = workbook.createSheet(" MONTHLY INVOICE DETAILS ");
    ...
    private void writeHeaderTopic() {
        ...
        createCell(row2, 0, " MONTHLY INVOICE DETAILS ", style2);
...
//            createCell(row, 1, record.getName(), style);
//            createCell(row, 2, record.getItem_code(), style);
//
//            for (getMonthlyInvDtlsListResponse response:record.getResponseList()){
//
//                System.out.println();
//                if (response.getSize_id()==1){
//                    createCell(row, 3, response.getFld_Qty(), style);
//                }else if (response.getSize_id()==2){
//                    createCell(row, 4, response.getFld_Qty(), style);
//                }else if (response.getSize_id()==3){
//                    createCell(row, 5, response.getFld_Qty(), style);
//                }else if (response.getSize_id()==4){
//                    createCell(row, 6, response.getFld_Qty(), style);
//                }else if (response.getSize_id()==5){
//                    createCell(row, 7, response.getFld_Qty(), style);
//                }else if (response.getSize_id()==6){
//                    createCell(row, 8, response.getFld_Qty(), style);
//                }else if (response.getSize_id()==7){
//                    createCell(row, 9, response.getFld_Qty(), style);
//                }else if (response.getSize_id()==8){
//                    createCell(row, 10, response.getFld_Qty(), style);
//                }else if (response.getSize_id()==9){
//                    createCell(row, 11, response.getFld_Qty(), style);
//                }
//            }
//
//            createCell(row, 12, record.getTot(), style);

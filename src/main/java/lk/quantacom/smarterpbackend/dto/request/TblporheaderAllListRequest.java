...
@Data
public class TblporheaderAllListRequest {
    ...
    private List<TblpormainmaterialsRequest> tblpormainmaterialsRequests;

    private List<TblporaccessoriesRequest> tblporaccessoriesRequests;

    private List<TblporsizesRequest> tblporsizesRequests;

    private List<TblporfitsRequest> tblporfitsRequests;
